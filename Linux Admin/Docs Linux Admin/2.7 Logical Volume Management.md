...
| pvchange | Ta có thể ngăn việc phân bổ lại một physical volume trong một volume group mới hoắc logical volume. Điều này hữu dụng khi ta có ý định xóa một physical volume. Ex: pvchange -xn /dev/sdb1 |
